...
class PivotalTrackerAPI
{
    ...
    public $token = null;
        ...
        protected $username = 'kjana@bu.edu';
        protected $password = 'gayu1986';
    ...
    public function tokens_active( $username, $password ){
     ...
     protected function _store_authentication( $token_arr ){
        ...
        // Execute mainly feectches the REST call and parsel the result 
        // this parsed is got in an array 
    ...
    protected function _execute( $function, $vars=null, $method='GET', $auth=null ){
            ...
            return  $xml; // Note: as of now reeturning the raw XML 
         ...
         protected function _process_xml($xml
           ...
           // print_r(htmlentities($xml));
            ...
            return $result_arr;
        } // End of protected function _process_xml( 
       ...
       // This is the Generalised method to call necessary REST call 
...
protected function _curl( $function, $vars = null, $method = 'GET', $auth = null ){
            ...
            // Notexxxxx: This would  accept any certificate (even self signed ones) and is essentially unsecure
         ...
         //   $this->_rest_debug($ch);
            ...
            return $output;
        } // End of protected function _curl
