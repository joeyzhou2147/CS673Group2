...
<head>
    ...
    <script type="text/javascript" language="JavaScript">
        ...
        function showBugByStoryId(storyId) {
            url = "/cs673group2/index.php/bug?" + storyId;
            xmlhttp = null;
            ...
            if (xmlhttp != null) {
                window.location.href = "/cs673group2/index.php/bug?storyId=" + storyId;
...
<div class="container">
    ...
    <table class="table table-hover">
        ...
        foreach ($storyindex as $stories) {
            ?>
            <tr>
                <td onclick="showBugByStoryId('<?php echo $stories->story_id ;?>')" style="cursor: pointer;">
